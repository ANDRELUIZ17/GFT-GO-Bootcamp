...
import dominio.negocio.TransacaoHelper;
import dominio.negocio.ValidacaoHelper;
...
public class BancoDigital {
    public static void main(String[] args) {
        ...
        System.out.println("*---------------------------------------*");
        System.out.println("|Bem vindo ao BigBank!                   ");
        System.out.println("|Aqui é possivel: criar conta, depositar, sacar e transferir. ");
        System.out.println("*---------------------------------------*)");
